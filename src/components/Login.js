      ...
      <div className="auth">
        ...
        <form className="auth__form" onSubmit={ handleSubmitButton }>
          ...
          <label htmlFor="password-input" className="auth__label">
            <input id="password-input" type="password" onChange={ handlePass } value={ password || '' } className="auth__input"
                   name="password" required placeholder="Пароль" minLength="6" maxLength="18" />
